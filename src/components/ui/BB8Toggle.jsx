/**
 * BB8StarWarsToggle
 * Adapted from 21st.dev star-wars-toggle-switch
 * Uses styled-components (npm install styled-components)
 * Usage: <BB8Toggle checked={isDark} onChange={toggleTheme} />
 */
...
const StyledWrapper = styled.div`
  ...
  .bb8__head::before {
    ...
    border-radius: var(--radius); top: 0.413em; left: 50%;
  ...
  .bb8__head::after {
    content: ""; position: absolute; bottom: 0.375em; left: 0;
    width: 100%; height: 0.188em;
  ...
  .bb8__antenna {
    ...
    width: 0.059em; border-radius: var(--radius) var(--radius) 0 0; transition: var(--transition);
  }
  .bb8__antenna:nth-child(1) {
    height: 0.938em; right: 0.938em;
    background: linear-gradient(#000 0.188em, silver 0.188em);
  }
  .bb8__antenna:nth-child(2) {
    height: 0.375em; left: 50%;
    transform: translate(-50%, -90%); background: silver;
  }
  .bb8__body {
    width: 4.375em; height: 4.375em; background: var(--bb8-bg);
    border-radius: var(--radius); position: relative; overflow: hidden;
    transition: var(--transition); z-index: 1; transform: rotate(45deg);
  ...
  .bb8__body::after {
    content: ""; bottom: 1.5em; left: 0.563em; position: absolute;
    width: 0.188em; height: 0.188em; background: rgb(236,236,236);
    border-radius: 50%;
    box-shadow: 0.875em 0.938em, 0 -1.25em, 0.875em -2.125em, 2.125em -2.125em, 3.063em -1.25em, 3.063em 0, 2.125em 0.938em;
    color: rgb(236,236,236);
  }
  .bb8__body::before {
    content: ""; width: 2.625em; height: 2.625em; position: absolute;
    border-radius: 50%; z-index: 0.1; overflow: hidden; top: 50%; left: 50%;
    transform: translate(-50%, -50%); border: 0.313em solid var(--accent);
  ...
  .bb8__shadow {
    ...
    background: #3a271c; box-shadow: 0.313em 0 3.125em #3a271c;
  ...
  .bb8-toggle__scenery::before {
    ...
    bottom: 0; background: #b18d71; z-index: 1;
  }
  .bb8-toggle__cloud {
  ...
  .bb8-toggle__cloud:nth-last-child(2) {
    top: 0.625em; right: 4.375em; width: 0.875em; height: 0.375em;
    background: #dfdedeae;
  ...
  .bb8-toggle__cloud:nth-last-child(3) {
    top: 1.25em; right: 0.938em; width: 0.875em; height: 0.375em;
    background: #ffffffae;
  ...
  .gomrassen, .hermes, .chenini {
    ...
    background: linear-gradient(#fff, #6e8ea2); top: 100%;
  }
  .gomrassen {
    left: 0.938em; width: 1.875em; height: 1.875em;
  ...
  .gomrassen::before, .gomrassen::after {
    ...
    box-shadow: inset 0 0 0.063em rgb(140,162,169); background: rgb(184,196,200);
  }
  ...
  .bb8-toggle__star {
    position: absolute; width: 0.063em; height: 0.063em;
    background: #fff; border-radius: var(--radius);
    filter: drop-shadow(0 0 0.063em #fff); color: #fff; top: 100%;
  }
  ...
  /* Actions when checked (dark mode = night = checked) */
...
export default function BB8Toggle({ checked, onChange }) {
  return (
    <StyledWrapper>
      <label className="bb8-toggle" title={checked ? 'Switch to light mode' : 'Switch to dark mode'}>
        <input
